...
export const en = {
  ...
  "explorer.setAttachmentFolder": "Set as attachment folder",
  "explorer.setAttachmentFolderDone": "New attachments will be saved to “{folder}”",
  ...
  "explorer.copyObsidianUrl": "Copy Obsidian URL",
  "explorer.copyAbsolutePath": "Copy absolute path",
  "explorer.copiedPath": "Path copied to clipboard",
  "explorer.copiedUrl": "Obsidian URL copied to clipboard",
  "explorer.copiedAbsolutePath": "Absolute path copied to clipboard",
  "explorer.revealInSystem": "Show in system explorer",
  "explorer.openInDefaultApp": "Open in default app",
  ...
  "explorer.deleteConfirmBulk": "Move {count} items to trash?",
  "explorer.attachmentDeleteTitle": "Delete attachments?",
  "explorer.attachmentDeletePrompt":
    "Also delete {count} attachment(s) used only by this note?\n{list}",
  "explorer.bulkMovePartial": "Moved {moved}, skipped {skipped}",
  ...
  "switcher.mergeConfirm": "Merge \"{source}\" into \"{target}\"? The merged note will be moved to trash.",
  "switcher.mergeConfirmTitle": "Merge notes",
...
export const zh: Record<keyof typeof en, string> = {
  ...
  "explorer.setAttachmentFolder": "设为附件文件夹",
  "explorer.setAttachmentFolderDone": "新附件将保存到「{folder}」",
  "explorer.openInNewTab": "在新标签页打开",
  "explorer.openToRight": "在右侧打开",
  "explorer.makeCopy": "制作副本",
  "explorer.copyPath": "复制库内路径",
  "explorer.copyObsidianUrl": "复制 Obsidian 链接",
  "explorer.copyAbsolutePath": "复制绝对路径",
  "explorer.copiedPath": "已复制库内路径到剪贴板",
  "explorer.copiedUrl": "已复制 Obsidian 链接到剪贴板",
  "explorer.copiedAbsolutePath": "已复制绝对路径到剪贴板",
  "explorer.revealInSystem": "在系统资源管理器中显示",
  "explorer.openInDefaultApp": "用默认应用打开",
  "explorer.moveTo": "移动到…",
  ...
  "explorer.deleteConfirmBulk": "将 {count} 个项目移到回收站？",
  "explorer.attachmentDeleteTitle": "删除附件？",
  "explorer.attachmentDeletePrompt":
    "一并删除仅被此笔记引用的 {count} 个附件？\n{list}",
  "explorer.bulkMovePartial": "已移动 {moved}，跳过 {skipped}",
  ...
  "switcher.mergeConfirm": "将「{source}」合并进「{target}」？被合并的笔记将移入回收站。",
  "switcher.mergeConfirmTitle": "合并笔记",
