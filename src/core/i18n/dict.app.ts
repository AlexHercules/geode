...
export const en = {
  ...
  "app.outgoingLinksTab": "Outgoing links",
  "app.outlineTab": "Outline",
  "app.ribbonAria": "Primary",
  "app.leftPanelAria": "Left panel",
  ...
  "app.tabPin": "Pin",
  "app.tabUnpin": "Unpin",
  "app.tabStack": "Stack tabs",
  "app.tabUnstack": "Unstack tabs",
  "app.moreOptions": "More options",
  "app.openTabs": "Show open tabs",
  ...
  "vaultManager.title": "Open or manage vaults",
  "vaultManager.empty": "No recent vaults yet.",
  "vaultManager.open": "Open",
  "vaultManager.openOther": "Open another vault…",
  "vaultManager.remove": "Remove from vault list",
  "vaultManager.createNew": "Create new vault…",
  "vaultManager.manage": "Manage vaults…",
  "vaultManager.version": "Version {version}",
  "vaultManager.create": "Create",
  "vaultManager.createTitle": "Create a new vault",
  "vaultManager.createDescription": "Create a new local folder for your notes.",
  "vaultManager.openTitle": "Open an existing vault",
  "vaultManager.openDescription": "Open a folder on this device as a vault.",
  "vaultManager.language": "Language",
  "vaultManager.languageDescription": "Choose the interface language.",
  "vaultManager.copyId": "Copy vault ID",
  "vaultManager.idCopied": "Vault ID copied",
  "vaultManager.rename": "Rename vault…",
  "vaultManager.renameHint": "Changes the name shown in the vault manager. The folder and its files are not renamed.",
  "vaultManager.relocate": "Move vault…",
  "vaultManager.relocateHint": "Update this record after moving the vault folder. Geode will not move or modify any files.",
  "vaultManager.reveal": "Reveal vault folder",
  "vaultContext.reveal": "Show in system explorer",
  "vaultContext.copyPath": "Copy path",
  "vaultContext.pathCopied": "Vault path copied",
  "app.close": "Close",
  "app.cancel": "Cancel",
  "app.save": "Save",
  "vaultManager.createNonEmptyConfirm": "The selected folder is not empty. Use it as a vault anyway?",
  ...
  "cmd.openLocalGraph": "Open local graph",
  "cmd.openHelp": "Open help",
  "cmd.openReleaseNotes": "Open release notes",
  ...
  "cmd.toggleBacklinksInDocument": "Backlinks: Toggle backlinks in document",
  ...
  "cmd.openOutgoingLinks": "Outgoing links: Open outgoing links for the current file",
  "cmd.openOutline": "Outline: Open outline of the current file",
  ...
  "cmd.showFileProperties": "Properties view: Show file properties",
  "cmd.showDebugInfo": "Show debug info",
  "debugInfo.copied": "Debug info copied to clipboard",
  "cmd.revealInSystem": "Files: Show in system explorer",
  "cmd.openInDefaultApp": "Files: Open in default app",
  ...
  "cmd.createNewVault": "Create new vault",
  ...
  "cmd.fold": "Fold",
  "cmd.unfold": "Unfold",
  "cmd.focusEditor": "Focus on the editor",
  ...
  "cmd.moveHeading": "Move current heading to a new note",
...
export const zh: Record<keyof typeof en, string> = {
  ...
  "app.outgoingLinksTab": "出链",
  "app.outlineTab": "大纲",
  "app.ribbonAria": "主功能区",
  "app.leftPanelAria": "左侧面板",
  ...
  "app.tabUnpin": "取消固定",
  "app.tabStack": "堆叠标签页",
  "app.tabUnstack": "取消堆叠标签页",
  "app.moreOptions": "更多选项",
  "app.openTabs": "显示已打开标签页",
  ...
  "vaultManager.title": "打开或管理仓库",
  "vaultManager.empty": "暂无最近仓库。",
  "vaultManager.open": "打开",
  "vaultManager.openOther": "打开其他仓库…",
  "vaultManager.remove": "从仓库列表中移除",
  "vaultManager.createNew": "新建仓库…",
  "vaultManager.manage": "管理仓库…",
  "vaultManager.version": "版本 {version}",
  "vaultManager.create": "创建",
  "vaultManager.createTitle": "创建新仓库",
  "vaultManager.createDescription": "为笔记创建一个新的本地文件夹。",
  "vaultManager.openTitle": "打开现有仓库",
  "vaultManager.openDescription": "将设备上的文件夹作为仓库打开。",
  "vaultManager.language": "语言",
  "vaultManager.languageDescription": "选择界面显示语言。",
  "vaultManager.copyId": "复制仓库 ID",
  "vaultManager.idCopied": "已复制仓库 ID",
  "vaultManager.rename": "重命名仓库…",
  "vaultManager.renameHint": "仅修改仓库管理器中显示的名称，不会重命名文件夹或修改任何文件。",
  "vaultManager.relocate": "移动仓库…",
  "vaultManager.relocateHint": "在外部移动仓库文件夹后更新记录路径。Geode 不会移动或修改任何文件。",
  "vaultManager.reveal": "在访达中显示仓库文件夹",
  "vaultContext.reveal": "在访达中显示",
  "vaultContext.copyPath": "复制路径",
  "vaultContext.pathCopied": "已复制仓库路径",
  "app.close": "关闭",
  "app.cancel": "取消",
  "app.save": "保存",
  "vaultManager.createNonEmptyConfirm": "所选文件夹非空。仍要将其用作仓库吗？",
  "app.errorTitle": "出错了",
  "app.errorBody":
  ...
  "cmd.toggleBacklinksInDocument": "反向链接：在文档中显示反链（开关）",
  ...
  "cmd.openOutgoingLinks": "出链：打开当前文件的出链",
  "cmd.openOutline": "大纲：打开当前文件的大纲",
  "cmd.showOutline": "大纲：显示大纲面板",
  "cmd.showTags": "标签：显示标签面板",
  "cmd.showAllProperties": "属性视图：显示所有属性",
  "cmd.showFileProperties": "属性视图：显示当前笔记的属性",
  "cmd.showDebugInfo": "显示调试信息",
  "debugInfo.copied": "调试信息已复制到剪贴板",
  "cmd.revealInSystem": "文件：在系统资源管理器中显示",
  "cmd.openInDefaultApp": "文件：用默认应用打开",
