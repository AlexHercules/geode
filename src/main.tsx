...
async function bootstrap() {
  ...
  // R201: link-at-cursor probe — exposes the pure scan so E2E can assert the
  // wikilink/markdown span + subpath + external detection deterministically (the
  // live editor:follow-link command is also E2E'd).
  const linkHost = globalThis as typeof globalThis & {
    __geodeLinkAtCursor?: (line: string, lineStart: number, cursor: number) => LinkAtCursor | null;
  };
