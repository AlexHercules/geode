...
## Round 210 additions — G3 §10「折叠/展开当前笔记属性」（1 命令 editor:toggle-fold-properties · 折叠属性面板 · 纯视图态[per-path Store]·不改文档 · data-safety 逻辑档[editor·CM heightmap] + 零新依赖）【As-built v0.206】
