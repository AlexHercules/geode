...
## Round 209 additions — G3 §2「插入附件」（1 命令 editor:attach-file · `<input type=file>` 选文件→拷进 vault→插 `![[]]` · 复用 R17 ingestFiles/importAttachment · data-safety 逻辑档[vault 二进制写·异步 picker] + 零新依赖）【As-built v0.205】
