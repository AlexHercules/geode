...
## Round 201 additions — G3 §4「打开光标处链接」（2 命令 editor:follow-link[⌥Enter] / editor:open-link-in-new-leaf[⌘Enter] · 复用 vetted openWikilink + resolveMarkdownLink · 纯导航零新写路径 · data-safety 逻辑档 + 零新依赖）【As-built v0.197】
