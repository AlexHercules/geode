...
## Round 202 additions — G3 §4「在新标签组中打开光标处链接」（1 命令 editor:open-link-in-new-split[⌘⌥Enter] · 续 R201 · followLinkAtCursor newTab→mode 重构 + 复用 vetted splitActivePane · 纯导航零新写路径 · data-safety 逻辑档 + 零新依赖）【As-built v0.198】
