...
## Round 203 additions — G C1「管理/切换仓库」首片（最近仓库 store + 切换器模态 + app:switch-vault 命令 · 重构 switchToVault 复用 openVaultFlow 切库全序 · data-safety 逻辑档[vault 切换] + 零新依赖）【As-built v0.199】
